...
numbSteps=50; %number of steps for the Markov process
...
fun_lambda=@(x,y)(exp(-(x.^4+x.*y+y.^2)/s^2));    
...
for jj=1:numbSteps
    ...
    probAccept=min(1,(pdfProposal./pdfCurrent));

    %acceptance-rejection step

    booleAccept=rand(numbSim,1) < probAccept;
